...
export default function DashboardPage() {
  ...
  const stats = [
    ...
    { label: 'Total Components', value: componentList.length, icon: Layers, href: '/components' },
  ]
    ...
    >
      ...
      <motion.div variants={shouldReduceMotion ? undefined : fadeUp}>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
          {[
            { href: '/components', label: `Browse all ${componentList.length} components`, sub: 'Explore the full component library' },
