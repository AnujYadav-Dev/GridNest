...
const STATS = [
  { value: String(componentList.length), label: 'Components' },
      ...
      >
        ...
        >
          <span className="inline-flex items-center gap-1.5 rounded-full border border-[var(--gridnest-border)] bg-[var(--gridnest-surface)] px-3 py-1 text-xs text-[var(--gridnest-text-secondary)]">
            ...
            {componentList.length} production-grade components - copy-paste ready
          </span>
        </motion.div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div>
            ...
            >
              ...
              utility in mind. {componentList.length} accessible, animated, TypeScript-first components
