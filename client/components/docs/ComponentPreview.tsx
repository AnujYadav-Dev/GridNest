        ...
        {tab === 'preview' ? (
          <motion.div
            ...
            className={`min-h-48 flex items-center justify-center p-8 ${
              previewTheme === 'light'
                ? 'bg-white [--gridnest-bg:#FFFFFF] [--gridnest-surface:#FFFFFF] [--gridnest-surface-2:#F3F4F6] [--gridnest-border:#E5E7EB] [--gridnest-border-hover:#D1D5DB] [--gridnest-text-primary:#111827] [--gridnest-text-secondary:#4B5563] [--gridnest-text-muted:#9CA3AF]'
                : 'bg-[var(--gridnest-bg)]'
            }`}
          >
            {children}
