...
export const DropdownCheckboxItem = forwardRef<React.ElementRef<typeof DropdownMenuPrimitive.CheckboxItem>, React.ComponentPropsWithoutRef<typeof DropdownMenuPrimitive.CheckboxItem>>(
  ({ className, children, ...props }, ref) => (
    <DropdownMenuPrimitive.CheckboxItem
      ref={ref}
      className={twMerge(
        clsx(
          "relative flex cursor-default select-none items-center rounded-[var(--gridnest-radius-sm)] py-1.5 pl-8 pr-2 text-sm font-body outline-none transition-colors",
          "focus:bg-[var(--gridnest-accent)] focus:text-white data-[disabled]:pointer-events-none data-[disabled]:opacity-50 text-[var(--gridnest-text-primary)]",
          className
        )
      )}
